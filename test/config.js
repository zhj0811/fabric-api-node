...
//    var createUserOpt2 = {
//         username : this.options.user_id2,
//         mspid : this.options.msp_id2,
//         cryptoContent : {
//             privateKey : await getKeyFilesInDir(this.options.privateKeyFolder2)[0],
//             signedCert : this.options.signedCert2
//         }
//     };
   ...
   // await co(function*(){
    ...
    // let user2 = await this.client.createUser(createUserOpt2);
...
//    this.channel.addPeer(peer);
   ...
   var data2 = fs.readFileSync(this.options.peer2_tls_cacerts);
   var peer2 = await this.client.newPeer(this.options.peer2_url, {
    //    pem : Buffer.from(data2).toString(),
    //    'ssl-target-name-override' : this.options.server_hostname
   });

//    this.channel.addPeer(peer2);
